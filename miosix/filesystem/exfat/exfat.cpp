/***************************************************************************
 *   Copyright (C) 2024 by Terraneo Federico, Caruso Nicolò                *
 *                                                                         *
...
namespace miosix
{
    ...
    public:
         ...
         */
        ExFatDirectory(intrusive_ref_ptr<FilesystemBase> parent, FastMutex &mutex,
    ...
    public:
         ...
         */
        ExFatFile(intrusive_ref_ptr<FilesystemBase> parent, int flags, FastMutex &mutex);
    ...
    ExFatFile::ExFatFile(intrusive_ref_ptr<FilesystemBase> parent, int flags, FastMutex &mutex)
    ...
    off_t ExFatFile::lseek(off_t pos, int whence)
    {
        ...
        if (int result = translateError(
                f_lseek(&file, static_cast<unsigned long>(offset))))
            return result;
